...
<script>
    export default {
        ...
        created() {
            ...
            this.axios({
                method: 'post',
                url: '/ssm_project/user/selectUserPage',
                data: postData1
            }).then(response => {
            ...
            this.axios({
                method: 'post',
                url: '/ssm_project/user/getRowCount',
                data: postData
            }).then(response => {
        ...
        methods: {
            ...
            addUser() {
                ...
                this.axios({
                    method: 'post',
                    url: '/ssm_project/user/createUser',
                    data: postData
                }).then(response => {
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('删除操作, 是否继续?', '提示', {
                    ...
                    this.axios({
                        method: 'post',
                        url: '/ssm_project/user/deleteUserById',
                        data: postData
                    }).then(response => {
                        this.getRowCount();
            ...
            handleDeleteList() {
                ...
                this.$confirm('删除操作, 是否继续?', '提示', {
                    ...
                    this.axios({
                        method: 'post',
                        url: '/ssm_project/user/deleteUserByIdList',
                        data: postData
                    }).then(response => {
                        this.getRowCount();
                        if (this.total % 5 == 1 && this.currentPage >= 1) {
            ...
            updateUser() {
                ...
                this.axios({
                    method: 'post',
                    url: '/ssm_project/user/updateUserById',
                    data: postData
                }).then(response => {
                    this.handlePageChange();
                    this.getRowCount();
